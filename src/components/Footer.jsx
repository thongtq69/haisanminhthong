...
const Footer = () => {
  const footerLinks = {
    'Về Chúng Tôi': ['Câu Chuyện', 'Cam Kết Chất Lượng', 'Bền Vững', 'Tuyển Dụng'],
    'Dịch Vụ Khách Hàng': ['Chính Sách Giao Hàng', 'Chính Sách Đổi Trả', 'Câu Hỏi Thường Gặp', 'Liên Hệ'],
    'Sản Phẩm': ['Ghẹ Tươi Sống', 'Ghẹ Chế Biến Sẵn', 'Combo Noel', 'Hải Sản Khác'],
    'Tài Nguyên': ['Công Thức', 'Mẹo Bảo Quản', 'Thông Tin Dinh Dưỡng', 'Blog'],
  };

  return (
    <footer className="bg-gradient-to-b from-ocean-blue to-gray-900 text-white relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        {[...Array(15)].map((_, i) => (
          ...
          >
            {i % 4 === 0 ? <IconSnow /> : i % 4 === 1 ? <IconTree /> : i % 4 === 2 ? <IconBell /> : '🦀'}
          </motion.div>
        ))}
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              ...
              Giao chất lượng và độ tươi đến tận nhà, đặc biệt trong mùa lễ hội.
            </p>
